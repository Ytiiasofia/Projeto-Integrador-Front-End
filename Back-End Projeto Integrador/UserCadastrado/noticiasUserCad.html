    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                ...
                <li><a href="noticiasUserCad.html"class="active">Notícias</a></li>
              ...
              <div class="row gy-4">
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Dolorum optio tempore voluptas dignissimos</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Nisi magni odit consequatur autem nulla dolorem</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Possimus soluta ut id suscipit ea ut in quo quia et soluta</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Non rem rerum nam cum quo minus olor distincti</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Accusamus quaerat aliquam qui debitis facilis consequatur</a>
                    </h2>
                ...
                <div class="col-lg-6">
                  <article>
                    ...
                    <h2 class="title">
                      <a href="noticiaDetalhesUserCad.html">Distinctio provident quibusdam numquam aperiam aut</a>
                    </h2>
