    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <nav id="navmenu" class="navmenu">
                ...
                <li><a href="forumAdm.html" class="active">Fórum</a></li>
        ...
        <div class="page-title dark-background" data-aos="fade" style="background-image: url(../assets/img/services-page-title-bg.jpg);">
            <div class="container">
                ...
                <nav class="breadcrumbs">
                    <ol>
                        <li class="current">Gerencie as postagens de usuários no fórum</li>
                    </ol>
                </nav>
            </div>
        </div>
                                    ...
                                    <div class="d-flex mb-3">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <button class="btn btn-sm btn-outline-danger delete-post-btn" data-bs-toggle="modal" data-bs-target="#deletePostModal">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger" id="confirmDeletePost">Excluir</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(e) {
        ...
        // Variável para armazenar o post que será deletado
    let postToDelete = null;
    
    // Quando clicar no botão de deletar
    document.addEventListener('click', function(e) {
        if (e.target.closest('.delete-post-btn')) {
            postToDelete = e.target.closest('.forum-post');
        }
    });
