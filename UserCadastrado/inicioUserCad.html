  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row">
          <div class="col-xl-4">
            <h1 data-aos="fade-up">Fortalecendo Caminhos na Tecnologia</h1>
            ...
            <div class="swiper init-swiper">
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="item">
                    <h3 class="mb-3">Encontre Apoio e Compartilhe Vivências</h3>
                    <p> Nosso fórum é um espaço seguro e acolhedor para trocar experiências, tirar dúvidas e receber suporte de outras mulheres que também estão trilhando o caminho da tecnologia. 
                      Aqui, o apoio mútuo fortalece cada passo da sua jornada.</p>
                  </div>
                </div><!-- End slide item -->

                <div class="swiper-slide">
                  <div class="item">
                    <h3 class="mb-3">Descubra Oportunidades na Área</h3>
                    <p> Está em busca de estágios, cursos, eventos ou mentorias? Reunimos tudo em um só lugar para facilitar o seu acesso e ampliar suas chances de crescimento na área. 
                      Aproveite as oportunidades e avance com mais confiança no seu percurso profissional.</p>
                  </div>
                </div><!-- End slide item -->
                ...
                <div class="swiper-slide">
                  <div class="item">
                    ...
                    <p> Acompanhe notícias relevantes, tendências do mercado e conquistas inspiradoras de mulheres que estão fazendo a diferença. 
                      Informação de qualidade para manter você atualizada, motivada e conectada com o universo da tecnologia.</p>
                  </div>
                </div><!-- End slide item -->
              </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="100">
            ...
            <div>
              ...
              <a href="oportunidadesUserCad.html" class="readmore stretched-link"><span>Saiba Mais</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
          <!-- End Service Item -->
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="200">
            ...
            <div>
              ...
              <a href="noticiasUserCad.html" class="readmore stretched-link"><span>Saiba Mais</span><i class="bi bi-arrow-right"></i></a>
            </div>
          ...
          <div class="col-lg-4 col-md-6 service-item d-flex" data-aos="fade-up" data-aos-delay="300">
            ...
            <div>
              ...
              <a href="forumUserCad.html" class="readmore stretched-link"><span>Saiba Mais</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div><!-- End Service Item -->
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
              ...
              <a href="noticiaDetalhesUserCad.html" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
...
<footer id="footer" class="footer light-background">
    <div class="footer-top">
        <div class="container">
            <div class="row gy-4">
                <!-- Logo e descrição (EXTREMA ESQUERDA) -->
